        ...
        <nav className="fixed top-0 left-0 w-full bg-white/50 backdrop-blur-lg shadow-lg border-b border-gray-200 dark:bg-black dark:border-gray-700 z-50">
          <div className="flex items-center justify-between px-4 md:px-8 py-2">
            ...
            <div className="hidden md:flex items-center gap-10">
              ...
              <button
                ...
                className="text-xl font-ubuntu text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
              >
                FAQ
              </button>
            </div>
          ...
          {menuOpen && (
            <div className="md:hidden flex flex-col gap-4 bg-white dark:bg-black px-6 py-4">
              ...
              <button
                onClick={handleFaqClick}
                className="text-lg text-gray-700 dark:text-gray-300 text-left"
              >
                FAQ
              </button>
            </div>
